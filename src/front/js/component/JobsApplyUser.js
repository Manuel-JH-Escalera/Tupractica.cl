...
import JSONDATA from "/workspace/react-flask-hello/src/Data para pruebas/MOCK_DATA.json"
...
const JobsApplication = () => {
    ...
    return (
    <>  
    <h2 className="text-Start m-5">Nombre estas son las postulaciones que has realizado:</h2>
